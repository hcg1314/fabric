...
import (
	...
	scc2 "github.com/hyperledger/fabric/core/scc"
)
...
func New() scc2.SelfDescribingSysCC {
	return &scc{}
}

type scc struct{}

func (s *scc) Name() string { return "cmscc" }
func (s *scc) Chaincode() shim.Chaincode { return s }
...
func (s *scc) getAllSigningRequest(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	return shim.Success(nil)
}
